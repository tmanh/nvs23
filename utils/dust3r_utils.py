...
def save_colmap_cameras(ori_size, intrinsics, camera_file_path):
    with open(camera_file_path, 'w') as cameras_file:
        ...
        for i, K in enumerate(intrinsics, 1):  # Starting index at 1
            ...
            cameras_file.write(f"{i} PINHOLE {width} {height} {K[0, 0]*scale_factor_x} {K[1, 1]*scale_factor_x} {width/2} {height/2}\n")               # scale focal
...
def save_colmap_images(poses, images_file, train_img_list):
    with open(images_file, 'w') as images_file:
        ...
        for i, pose in enumerate(poses, 1):  # Starting index at 1
            ...
            images_file.write(f"{i} {q[0]} {q[1]} {q[2]} {q[3]} {t[0]} {t[1]} {t[2]} {i} {train_img_list[i-1]}\n")
            images_file.write(f"\n")
